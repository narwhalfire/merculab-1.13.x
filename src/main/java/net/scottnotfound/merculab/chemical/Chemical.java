...
public class Chemical extends ForgeRegistryEntry<Chemical> {
    ...
    public static class Properties {
        ...
        public static final Properties WATER = new Properties(18000,
                                                              1000000,
                                                              273,
                                                              373);
        public static final Properties METHANE = new Properties(16000,
                                                                657,
                                                                91,
                                                                112);
        public static final Properties SODIUM_CHLORIDE = new Properties(58443,
                                                                        2170000,
                                                                        1074,
                                                                        1738);
        public static final Properties FERRIC_OXIDE = new Properties(159687,
                                                                     5250000,
                                                                     1812,
                                                                     0);
